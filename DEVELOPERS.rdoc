...
not have to be human-readable.  To create your own generator see
RDoc::Generator.
...
attribute.  A formatter could count the number of words and the average word length for a comment, for example.
