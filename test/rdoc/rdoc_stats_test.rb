...
class RDocStatsTest < RDoc::TestCase
  ...
  def test_report_attr_line
    ...
    assert_match 'C#a file.rb:3', @s.report
  end
  ...
  def test_report_constant_line
    ...
    assert_match 'M::C file.rb:5', @s.report
  end
  ...
  def test_report_method_line
    ...
    assert_match 'C#m1 file.rb:4', @s.report
  end
...
m(a, b) { |c, d| ... }
  ...
  # New tests for file-centric format
  ...
  def test_report_multiple_files
    ...
    assert_match(/file\.rb:/, report)
    assert_match(/other\.rb:/, report)
    assert_match(/Class:\n\s+C1/, report)
    assert_match(/Class:\n\s+C2/, report)
  end
  ...
  def test_report_multi_file_class
    ...
    assert_match(/ext\.c:/, report)
    assert_match(/C#c_method/, report)
    assert_match(/file\.rb:/, report)
    assert_match(/C#ruby_method/, report)
  end
