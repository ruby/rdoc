...
class RDoc::Markup::ToTexInfo < RDoc::Markup::Formatter
  ...
  def init_tags
    @attr_tags = [
      InlineTag.new(RDoc::Markup::Attribute.bitmap_for(:BOLD), l("@strong{"), l("}")),
      InlineTag.new(RDoc::Markup::Attribute.bitmap_for(:TT),   l("@code{"), l("}")), # @code{typewriter}
  ...
  def convert_special(special)
    ...
    # raise "Unhandled special: #{special}" unless handled # I stab you!
    special.text
  end
